...
| S16-06-01 | Factory claim PostgreSQL store | Defect/claim evidence persists with reason, claim window, quantity impact, and actor refs | `apps/api/internal/modules/production/application/postgres_subcontract_factory_claim_store.go` |
